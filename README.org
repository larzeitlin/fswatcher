...
its public interface. This could be easly achived with a sript that envokes the component with a
...
Handling the cases of failed connection and poll events expecially is important and has
