...
* to dos:
** TODO: update polling mechanism to use threads etc
** TODO: write a system test
** TODO: Add build / invocation args
** TODO: more details about actions, polling in doc
** TODO: reformat doc to match the requirements
** TODO: notes about error handling, logging, scaling
